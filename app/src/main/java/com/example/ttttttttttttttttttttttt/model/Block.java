...
public class Block {
    ...
    /**
     * createBlock() случайным образом выбирает индекс формы тетромино в Shape классе enum и
     * в BlockColor и присваивает два случайно выбранных значения для shape Index и
     * blockColor. Создается новый Block экземпляр с двумя значениями, переданными в качестве аргументов,
     * и устанавливается положение блока по оси X.
     * Наконец, createBlock() возвращает созданный и инициализированный блок.
     */
